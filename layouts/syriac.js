/* Syriac keyboard layouts
 * contains layout: 'syriac-phonetic', 'syriac-standard', 'syriac-sedra3', 'syriac-leiden', 'syriac-cal'
 *
 * To use:
 *  Point to this js file into your page header: <script src="layouts/syriac.js" type="text/javascript"></script>
 *  Initialize the keyboard using: $('input').keyboard({ layout: 'ssyriac-phonetic' });
 *
 * license for this file: WTFPL, unless the source layout site has a problem with me using them as a reference
 */

/* Based on the Phonetic Syriac keyboard */
...
/* Based on the Standard Syriac keyboard */
...
/* Based on the SEDRA3 transliteration format */
...
/* Based on the Leiden Peshitta transliteration format */
...
/* Based on the CAL Code transliteration format */
